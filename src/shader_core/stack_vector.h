...
namespace csc {
	...
	public:
		StackVectorIterator(const boost::optional<T>* arr_ptr) : arr_ptr{ arr_ptr }, use_vec{ false } {}
		StackVectorIterator(typename std::vector<T>::const_iterator vec_iter) : vec_iter{ vec_iter }, use_vec{ true } {}
